...
public class PongPanel extends JPanel implements ActionListener, KeyListener {
     ...
     private static final int WIN_TEXT_LX = 150;
     private static final int WIN_TEXT_RX = 300;
	...
	public void actionPerformed(ActionEvent event) {
	 ...
	 private void paintWin(Graphics g) {
		if (gameWinner == Player.One) {
         ...
         g.setFont(scoreFont);
		 String leftScore = WIN_TEXT;
		 g.drawString(leftScore, WIN_TEXT_LX, WIN_TEXT_Y);
			 ...
			 Font scoreFont = new Font(SCORE_FONT_FAMILY, Font.BOLD, SCORE_FONT_SIZE);
	         g.setFont(scoreFont);
			 String rightScore = WIN_TEXT;
			 g.drawString(rightScore, getWidth()-WIN_TEXT_RX, WIN_TEXT_Y);
